...
class ClassEsp8266WiFi {
    ...
    Init(_Bus)
    {
        ...
        //print(_Bus);
        print('Hey4');
        let wf = require('https://raw.githubusercontent.com/AlexGlgr/ModuleMiddleWIFIesp8266/fork-Alexander/js/module/ClassBaseWIFIesp8266.min.js').setup(_Bus, function(emsg) {
            if (emsg) {
                print('Hey3');
